  ...
  return (
    <main className="bg-[#FBFBFB]">
      ...
      <section className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between">
        <div className="bg-white p-8 rounded-lg w-[30rem] lg:w-[40rem] mx-auto md:mx-0">
          ...
          <div className="flex items-start text-start gap-4 my-10">
            ...
            <div className="space-y-5">
              <h2 className="font-semibold text-[#0F172A] text-2xl">
                Casio CA-500WE-1AEF
              </h2>
              <p className="font-semibold text-[#0F172A] text-2xl">N160,002</p>
        ...
        <div className="bg-white p-8 rounded-lg text-start w-[30rem] md:w-[35rem] mx-auto md:mx-0">
          <h1 className="font-semibold text-[#0F172A] text-2xl my-5">
            Delivery
          </h1>
          ...
          <div className="my-10">
            <div className="flex items-center justify-between">
              <input
                ...
                className="border-2 rounded-full p-4 border-[#AC702F] w-80"
              />
              <button className="bg-[#AC702F] px-12 py-4 text-white rounded-full">
                Apply
              </button>
            </div>
